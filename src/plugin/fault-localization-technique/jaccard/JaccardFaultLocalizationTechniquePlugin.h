 ...
 */
#ifndef JACCARDFAULTLOCALIZATIONTECHNIQUEPLUGIN_H
#define JACCARDFAULTLOCALIZATIONTECHNIQUEPLUGIN_H

#include "engine/CKernel.h"

namespace soda {

class JaccardFaultLocalizationTechniquePlugin : public IFaultLocalizationTechniquePlugin
{
public:
    JaccardFaultLocalizationTechniquePlugin();
    virtual ~JaccardFaultLocalizationTechniquePlugin();
...
#endif // JACCARDFAULTLOCALIZATIONTECHNIQUEPLUGIN_H
