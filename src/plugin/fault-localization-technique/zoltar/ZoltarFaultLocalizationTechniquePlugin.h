 ...
 */
#ifndef ZOLTARFAULTLOCALIZATIONTECHNIQUEPLUGIN_H
#define ZOLTARFAULTLOCALIZATIONTECHNIQUEPLUGIN_H

#include "engine/CKernel.h"

namespace soda {

class ZoltarFaultLocalizationTechniquePlugin : public IFaultLocalizationTechniquePlugin
{
public:
    ZoltarFaultLocalizationTechniquePlugin();
    virtual ~ZoltarFaultLocalizationTechniquePlugin();
...
#endif // ZOLTARFAULTLOCALIZATIONTECHNIQUEPLUGIN_H
