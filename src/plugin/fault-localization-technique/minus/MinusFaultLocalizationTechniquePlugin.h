 ...
 */
#ifndef MINUSFAULTLOCALIZATIONTECHNIQUEPLUGIN_H
#define MINUSFAULTLOCALIZATIONTECHNIQUEPLUGIN_H

#include "engine/CKernel.h"

namespace soda {

class MinusFaultLocalizationTechniquePlugin : public IFaultLocalizationTechniquePlugin
{
public:
    MinusFaultLocalizationTechniquePlugin();
    virtual ~MinusFaultLocalizationTechniquePlugin();
...
#endif // MINUSFAULTLOCALIZATIONTECHNIQUEPLUGIN_H
