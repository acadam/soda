 ...
 */
#ifndef KULCZYNKSI2FAULTLOCALIZATIONTECHNIQUEPLUGIN_H
#define KULCZYNKSI2FAULTLOCALIZATIONTECHNIQUEPLUGIN_H

#include "engine/CKernel.h"

namespace soda {

class Kulczynksi2FaultLocalizationTechniquePlugin : public IFaultLocalizationTechniquePlugin
{
public:
    Kulczynksi2FaultLocalizationTechniquePlugin();
    virtual ~Kulczynksi2FaultLocalizationTechniquePlugin();
...
#endif // KULCZYNKSI2FAULTLOCALIZATIONTECHNIQUEPLUGIN_H
