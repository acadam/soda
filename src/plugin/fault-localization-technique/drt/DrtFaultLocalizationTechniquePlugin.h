 ...
 */
#ifndef DRTFAULTLOCALIZATIONTECHNIQUEPLUGIN_H
#define DRTFAULTLOCALIZATIONTECHNIQUEPLUGIN_H

#include "engine/CKernel.h"

namespace soda {

class DrtFaultLocalizationTechniquePlugin : public IFaultLocalizationTechniquePlugin
{
public:
    DrtFaultLocalizationTechniquePlugin();
    virtual ~DrtFaultLocalizationTechniquePlugin();
...
#endif // DRTFAULTLOCALIZATIONTECHNIQUEPLUGIN_H
