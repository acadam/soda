 ...
 */
#ifndef WONG3FAULTLOCALIZATIONTECHNIQUEPLUGIN_H
#define WONG3FAULTLOCALIZATIONTECHNIQUEPLUGIN_H

#include "engine/CKernel.h"

namespace soda {

class Wong3FaultLocalizationTechniquePlugin : public IFaultLocalizationTechniquePlugin
{
public:
    Wong3FaultLocalizationTechniquePlugin();
    virtual ~Wong3FaultLocalizationTechniquePlugin();
...
#endif // WONG3FAULTLOCALIZATIONTECHNIQUEPLUGIN_H
