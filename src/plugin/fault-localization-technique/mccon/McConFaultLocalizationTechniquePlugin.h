 ...
 */
#ifndef MCCONFAULTLOCALIZATIONTECHNIQUEPLUGIN_H
#define MCCONFAULTLOCALIZATIONTECHNIQUEPLUGIN_H

#include "engine/CKernel.h"

namespace soda {

class McConFaultLocalizationTechniquePlugin : public IFaultLocalizationTechniquePlugin
{
public:
    McConFaultLocalizationTechniquePlugin();
    virtual ~McConFaultLocalizationTechniquePlugin();
...
#endif // MCCONFAULTLOCALIZATIONTECHNIQUEPLUGIN_H
