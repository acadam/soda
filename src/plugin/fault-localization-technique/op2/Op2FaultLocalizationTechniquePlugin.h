 ...
 */
#ifndef OP2FAULTLOCALIZATIONTECHNIQUEPLUGIN_H
#define OP2FAULTLOCALIZATIONTECHNIQUEPLUGIN_H

#include "engine/CKernel.h"

namespace soda {

class Op2FaultLocalizationTechniquePlugin : public IFaultLocalizationTechniquePlugin
{
public:
    Op2FaultLocalizationTechniquePlugin();
    virtual ~Op2FaultLocalizationTechniquePlugin();
...
#endif // OP2FAULTLOCALIZATIONTECHNIQUEPLUGIN_H
