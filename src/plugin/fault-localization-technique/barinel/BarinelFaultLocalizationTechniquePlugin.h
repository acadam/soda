 ...
 */
#ifndef BARINELFAULTLOCALIZATIONTECHNIQUEPLUGIN_H
#define BARINELFAULTLOCALIZATIONTECHNIQUEPLUGIN_H

#include "engine/CKernel.h"

namespace soda {

class BarinelFaultLocalizationTechniquePlugin : public IFaultLocalizationTechniquePlugin
{
public:
    BarinelFaultLocalizationTechniquePlugin();
    virtual ~BarinelFaultLocalizationTechniquePlugin();
...
#endif // BARINELFAULTLOCALIZATIONTECHNIQUEPLUGIN_H
