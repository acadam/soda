 ...
 */
#ifndef BASEMODELFAULTLOCALIZATIONTECHNIQUEPLUGIN_H
#define BASEMODELFAULTLOCALIZATIONTECHNIQUEPLUGIN_H

#include "engine/CKernel.h"

namespace soda {

class BasemodelFaultLocalizationTechniquePlugin : public IFaultLocalizationTechniquePlugin
{
public:
    BasemodelFaultLocalizationTechniquePlugin();
    virtual ~BasemodelFaultLocalizationTechniquePlugin();
...
#endif // BASEMODELFAULTLOCALIZATIONTECHNIQUEPLUGIN_H
